...
const Footer = () => {
  return (
    <footer className="bg-black/15 text-black/55 py-8 px-6">
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-left">

        {/* Left - Brand */}
        <div>
          <h2 className="text-2xl font-bold text-yellow-800">Ragul Prasanth</h2>
          <p className="mt-2 ">
        ...
        {/* Middle - Contact Info */}
        <div>
          <h3 className="text-xl font-semibold text-yellow-800 mb-3">Contact</h3>
          <p>
        ...
        {/* Right - Social Links */}
        <div>
          <h3 className="text-xl font-semibold text-yellow-800 mb-3">Follow Me</h3>
